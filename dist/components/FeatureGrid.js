...
function FeatureGrid({ items, headingClassName, variant = "card", }) {
    ...
    return ((0, jsx_runtime_1.jsx)("section", { "data-block": "feature-grid", "data-variant": variant, children: (0, jsx_runtime_1.jsx)("ul", { children: items.map((item, index) => (
            ...
            (0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsxs)("a", { href: item.href, children: [item.imageUrl ? ((0, jsx_runtime_1.jsx)("img", { src: item.imageUrl, alt: item.imageAlt ?? "" })) : null, (0, jsx_runtime_1.jsxs)("div", { "data-slot": "content", children: [(0, jsx_runtime_1.jsx)("h2", { className: headingClassName, children: item.heading }), (0, jsx_runtime_1.jsx)("p", { children: item.body })] }), variant === "solid" ? ((0, jsx_runtime_1.jsx)("span", { "data-slot": "arrow", "aria-hidden": "true" })) : null] }) }, index))) }) }));
}
